  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
      ...
      >
          ...
          <div className="relative z-20 mt-auto pt-10">
            ...
            <div className="mt-4 pt-4 border-t border-white/15 flex items-center justify-between text-[11px] text-sky-200/70">
              <span className="flex items-center gap-1">
                <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" /> Secure Hashed Password Auth
              </span>
        ...
        {/* RIGHT FORM PANEL */}
        <div className="w-full md:w-7/12 lg:w-1/2 p-6 sm:p-8 flex flex-col justify-center relative z-20 bg-slate-900/90 overflow-y-auto max-h-[85vh] md:max-h-[90vh]">
          {/* Mobile Travel Header Badge */}
          <div className="md:hidden flex items-center gap-2 mb-3 pb-2 border-b border-sky-300/20">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-sky-200/80 mt-0.5">
                    Create your user account to unlock trip planning, quotes, and saved destinations.
                  </p>
                </div>
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full py-2.5 px-4 rounded-2xl bg-white hover:bg-slate-100 text-slate-900 font-semibold text-xs transition-all flex items-center justify-center gap-2.5 shadow-md active:scale-98"
                >
                ...
                <div className="relative flex items-center justify-center my-0.5">
                  ...
                  <span className="bg-slate-900 px-3 text-[10px] text-sky-200/60 uppercase tracking-widest font-semibold shrink-0">
                ...
                {/* REGISTRATION FORM */}
                <form onSubmit={handleRegisterSubmit} className="flex flex-col gap-2.5 text-xs">
                  {/* Full Name */}
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2 rounded-xl bg-white/10 border border-sky-300/30 text-white text-xs placeholder-sky-200/40 focus:outline-none focus:border-sky-400"
                      />
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          className="w-full pl-9 pr-3 py-2 rounded-xl bg-slate-800 border border-sky-300/30 text-white text-xs focus:outline-none focus:border-sky-400"
                        >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-8 py-2 rounded-xl bg-white/10 border border-sky-300/30 text-white text-xs placeholder-sky-200/40 focus:outline-none focus:border-sky-400"
                        />
                        <button
                          type="button"
                  ...
                  <div className="flex items-start gap-2 pt-1">
                    <input
                      ...
                      className="mt-0.5 w-4 h-4 rounded bg-white/10 border-sky-300/30 text-sky-500 focus:ring-0 cursor-pointer"
                    />
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full mt-1.5 py-3 px-4 rounded-xl bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold text-xs transition-all shadow-lg flex items-center justify-center gap-2 disabled:opacity-50"
                  >
